				...
				<div className="dlab-bnr-inr overlay-black-middle no-line" style={{backgroundImage:"url(" + img + ")"}}>
					<div className="container">
						<div className="dlab-bnr-inr-entry">
							<h1 className="text-white">Nuestras Cartas 3</h1>
				...
				<div className="section-full bg-white">
						...
						<div className="col-lg-6">
							<div className="menu-box">
								<div className="section-head style-2">
									<h4 className="sub-title">Carne ROJA</h4>
									<h2 className="title">Costillar Frito - De Cordero</h2>
								</div>
								<ul className="menu-list-2">
									<li>
										<div className="info-price">
											<h5 className="title">Costillar Frito</h5>
											<div className="line"></div>
											<span className="price">22.00 S/.</span>
										</div>
										<p>- Costillas de cordero frito. - Papas Sancochadas. - Choclos o Maiz Sancochado. - Ensalada Criolla. </p>
									</li>
									<li>
										<div className="info-price">
											<h5 className="title">Costillas Frito 2</h5>
											<div className="line"></div>
											<span className="price">22.00 S/.</span>
										</div>
										<p>- Costillas de cordero frito. - Papas Sancochadas. - Choclos o Maiz Sancochado. - Ensalada Criolla.</p>
									...
									<li>
										<div className="info-price">
											<h5 className="title">Costillar Frito 3</h5>
											<div className="line"></div>
											<span className="price">22.00 S/.</span>
										</div>
										<p>- Costillas de cordero frito. - Papas Sancochadas. - Choclos o Maiz Sancochado. - Ensalada Criolla.</p>
									...
									<li>
										<div className="info-price">
											<h5 className="title">Costillar Frito 4</h5>
											<div className="line"></div>
											<span className="price">22.00 S/.</span>
										</div>
										<p>- Costillas de cordero frito. - Papas Sancochadas. - Choclos o Maiz Sancochado. - Ensalada Criolla.</p>
									...
									<li>
										<div className="info-price">
											<h5 className="title">Costillar Frito 5</h5>
											<div className="line"></div>
											<span className="price">22.00 S/.</span>
										</div>
										<p>- Costillas de cordero frito. - Papas Sancochadas. - Choclos o Maiz Sancochado. - Ensalada Criolla.</p>
									...
									<li>
										<div className="info-price">
											<h5 className="title">Costillar Frito 6</h5>
											<div className="line"></div>
											<span className="price">22.00 S/.</span>
										</div>
										<p>- Costillas de cordero frito. - Papas Sancochadas. - Choclos o Maiz Sancochado. - Ensalada Criolla.</p>
					...
					<div className="row manu-box-reverse sp0">
						<div className="col-lg-6">
							<div className="menu-box">
								<div className="section-head style-2">
									<h4 className="sub-title">Cuy Serrano</h4>
									<h2 className="title">Cuy Chactado</h2>
								</div>
								<ul className="menu-list-2">
									<li>
										<div className="info-price">
											<h5 className="title">Cuy Chactado</h5>
											<div className="line"></div>
											<span className="price">34.00 S/.</span>
										</div>
										<p>Cuy frito. - Papas Sancochadas - Ensalada a la Criolla - Maiz - Arroz </p>
									</li>
									<li>
										<div className="info-price">
