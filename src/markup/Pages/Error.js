							...
							<div className="row">
								<div className="col-lg-12">
									<div className="page-notfound text-center">
										<form method="post">
											<strong>404</strong>
											<h5 className="sub-title">Pagina  <i className="fa fa-exclamation-triangle text-primary"></i> no encontrada</h5>
											<Link to={'./'} className="btn btnhover">REGRESAR AL INICIO</Link>
										</form>
									</div>
								</div>
							</div>
