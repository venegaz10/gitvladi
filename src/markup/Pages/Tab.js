							...
							<div className="row tab-pane fade show active" >
								<div className="dz-col col m-b30">
									<div className="item-box shop-item style2">
										...
										<div className="item-info text-center">
											<h4 className="item-title"><Link to={'/shop-product-details'}>Especial</Link></h4>
											<h5 className="price text-primary"><del>45</del><span>S/. 20</span></h5>
											<div className="cart-btn"><Link to={'/shop-product-details'} className="btn btnhover radius-xl"><i className="ti-shopping-cart"></i> Mas Detalles</Link></div>
										</div>
									</div>
								</div>
								<div className="dz-col col m-b30">
									<div className="item-box shop-item style2">
										...
										<div className="item-info text-center">
											<h4 className="item-title"><Link to={'/shop-product-details'}>Especial + Extra</Link></h4>
											<h5 className="price text-primary"><del>45</del><span>S/. 20</span></h5>
											<div className="cart-btn"><Link to={'/shop-product-details'} className="btn btnhover radius-xl"><i className="ti-shopping-cart"></i> Mas Detalles</Link></div>
										</div>
									</div>
								...
								<div className="dz-col col m-b30">
									<div className="item-box shop-item style2">
										...
										<div className="item-info text-center">
											<h4 className="item-title"><Link to={'/shop-product-details'}>Especial + Lite</Link></h4>
											<h5 className="price text-primary"><del>45</del><span>S/. 20</span></h5>
											<div className="cart-btn"><Link to={'/shop-product-details'} className="btn btnhover radius-xl"><i className="ti-shopping-cart"></i> Mas Detalles</Link></div>
										</div>
									</div>
								...
								<div className="dz-col col m-b30">
									<div className="item-box shop-item style2">
										...
										<div className="item-info text-center">
											<h4 className="item-title"><Link to={'shop-product-details'}>Normal</Link></h4>
											<h5 className="price text-primary"><del>45</del><span>S/. 20</span></h5>
											<div className="cart-btn"><Link to={'shop-product-details'} className="btn btnhover radius-xl"><i className="ti-shopping-cart"></i> Mas Detalles</Link></div>
										</div>
									</div>
								...
								<div className="dz-col col m-b30">
									<div className="item-box shop-item style2">
										...
										<div className="item-info text-center">
											<h4 className="item-title"><Link to={'/shop-product-details'}>Normal + Mixto</Link></h4>
											<h5 className="price text-primary"><del>45</del><span>S/. 20</span></h5>
											<div className="cart-btn"><Link to={'/shop-product-details'} className="btn btnhover radius-xl"><i className="ti-shopping-cart"></i> Mas Detalles</Link></div>
										</div>
									</div>
							...
							<div className="row " >
								<div className="dz-col col m-b30">
									<div className="item-box shop-item style2">
										...
										<div className="item-info text-center">
											<h4 className="item-title"><Link to={'/shop-product-details'}>Normal + Mixto</Link></h4>
											<h5 className="price text-primary"><del>45</del><span>S/. 18</span></h5>
											<div className="cart-btn"><Link to={'/shop-product-details'} className="btn btnhover radius-xl"><i className="ti-shopping-cart"></i> Mas Detalles</Link>></div>
										</div>
									</div>
								</div>
								<div className="dz-col col m-b30">
									<div className="item-box shop-item style2">
										...
										<div className="item-info text-center">
											<h4 className="item-title"><Link to={'/shop-product-details'}>Normal + Mixto</Link></h4>
											<h5 className="price text-primary"><del>45</del><span>S/. 18$40</span></h5>
											<div className="cart-btn"><Link to={'/shop-product-details'} className="btn btnhover radius-xl"><i className="ti-shopping-cart"></i> Mas Detalles</Link>></div>
										</div>
									</div>
								</div>
							...
							<div className="row " >
								<div className="dz-col col m-b30">
									<div className="item-box shop-item style2">
										...
										<div className="item-info text-center">
											<h4 className="item-title"><Link to={'/shop-product-details'}>Normal + MixtoMuffin</Link></h4>
											<h5 className="price text-primary"><del>45</del><span>S/. 18</span></h5>
											<div className="cart-btn"><Link to={'/shop-product-details'} className="btn btnhover radius-xl"><i className="ti-shopping-cart"></i> Mas Detalles</Link>></div>
										</div>
									</div>
							...
							<div className="row " >
								...
								<div className="dz-col col m-b30">
									<div className="item-box shop-item style2">
										...
										<div className="item-info text-center">
											<h4 className="item-title"><Link to={'/shop-product-details'}>Normal + Mixtos</Link></h4>
											<h5 className="price text-primary"><del>45</del><span>S/. 18</span></h5>
											<div className="cart-btn"><Link to={'/shop-product-details'} className="btn btnhover radius-xl"><i className="ti-shopping-cart"></i> Mas Detalles</Link>></div>
										</div>
									</div>
